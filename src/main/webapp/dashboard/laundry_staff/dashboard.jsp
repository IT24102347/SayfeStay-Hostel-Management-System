...
<%
    ...
    if (allRequests == null) allRequests = new ArrayList<LaundryRequest>();
    if (allDamages == null) allDamages = new ArrayList<DamageReport>();
                    ...
                    <table style="width:100%;">
                        ...
                        <% } else {
                            for (DamageReport d : allDamages) {
                                ...
                                List<String> validPhotos = new ArrayList<String>();
